...
urlpatterns = [
    ...
    path('dashboard/uaccounts/view/<int:user_id>/client', views.view_userC, name='view_userC'),
    ...
    path('dashboard/subscribed/', views.subscription_list, name='subscription_list'),
